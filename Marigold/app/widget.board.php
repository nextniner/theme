						...
						<div class="input-group">
							...
							<div class="input-group-text">
								<div class="form-check form-check-inline me-0">
									...
									<input class="form-check-input" type="checkbox" name="wset[gr_except]" id="gr_except" value="1"<?php echo get_checked('1', $wset['gr_except'])?>>
									<label class="form-check-label" for="gr_except">제외</label>
								</div>
							 </div>
						</div>
					</div>
						...
						<div class="input-group">
							...
							<div class="input-group-text">
								<div class="form-check form-check-inline me-0">
									...
									<input class="form-check-input" type="checkbox" name="wset[bo_except]" id="bo_except" value="1"<?php echo get_checked('1', $wset['bo_except'])?>>
									<label class="form-check-label" for="bo_except">제외</label>
								</div>
							 </div>
						</div>
					</div>
				...
				<div class="row gx-2 mb-2">
					...
					<div class="col-md-10">
						<div class="input-group">
							...
							<input type="text" name="wset[ca_list]" value="<?php echo $wset['ca_list'] ?>" class="form-control" placeholder="분류명(ca_name) - 단일게시판 추출시에만 작동">
							<div class="input-group-text">
								<div class="form-check form-check-inline me-0">
									<?php $wset['ca_except'] = isset($wset['ca_except']) ? $wset['ca_except'] : ''; ?>
									<input class="form-check-input" type="checkbox" name="wset[ca_except]" id="ca_except" value="1"<?php echo get_checked('1', $wset['ca_except'])?>>
									<label class="form-check-label" for="ca_except">제외</label>
								</div>
							 </div>
						</div>
					</div>
						...
						<div class="input-group">
							...
							<div class="input-group-text">
								<div class="form-check form-check-inline me-0">
									...
									<input class="form-check-input" type="checkbox" name="wset[mb_except]" id="mb_except" value="1"<?php echo get_checked('1', $wset['mb_except'])?>>
									<label class="form-check-label" for="mb_except">제외</label>
								</div>
							 </div>
						</div>
					</div>
				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-10">
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" name="wset[wr_notice]" id="wr_notice" value="1"<?php echo get_checked('1', $wset['wr_notice'])?>>
				...
				<div class="row gx-2 mb-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" name="wset[rows]" min="1" value="<?php echo $wset['rows'] ?>" class="form-control">
				...
				<div class="row gx-2 mb-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" name="mo[rows]" min="1" value="<?php echo $mo['rows'] ?>" class="form-control">
							<span class="input-group-text">개</span>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" min="1" name="wset[page]" value="<?php echo $wset['page'] ?>" class="form-control">
				...
				<div class="row gx-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" min="1" name="wset[dayterm]" value="<?php echo $wset['dayterm'];?>" class="form-control">
