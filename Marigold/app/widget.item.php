			...
			<div class="col-md-10">
				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-10 sit_icon">
						...
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" id="it_hit" name="wset[type1]" value="1"<?php echo get_checked($wset['type1'], "1") ?>>
							<label class="form-check-label" for="it_hit">
						...
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" id="it_good" name="wset[type2]" value="1"<?php echo get_checked($wset['type2'], "1") ?>>
							<label class="form-check-label" for="it_good">
						...
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" id="it_new" name="wset[type3]" value="1"<?php echo get_checked($wset['type3'], "1") ?>>
							<label class="form-check-label" for="it_new">
						...
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" id="it_hot" name="wset[type4]" value="1"<?php echo get_checked($wset['type4'], "1") ?>>
							<label class="form-check-label" for="it_hot">
						...
						<div class="form-check form-check-inline">
							...
							<input class="form-check-input" type="checkbox" id="it_dc" name="wset[type5]" value="1"<?php echo get_checked($wset['type5'], "1") ?>>
							<label class="form-check-label" for="it_dc">
				...
				<div class="row gx-2 mb-2">
					...
					<div class="col-md-10">
						...
						<input type="text" name="wset[ca_list]" value="<?php echo $wset['ca_list'] ?>" class="form-control" placeholder="상품분류(ca_id)를 콤마(,)로 구분해서 복수 등록">
					</div>
				</div>
				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="number" name="wset[page]" min="1" value="<?php echo $wset['page'] ?>" class="form-control">
				...
				<div class="row gx-2 align-items-center">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="number" name="wset[dayterm]" min="1" value="<?php echo $wset['dayterm'];?>" class="form-control">
