...
if (!defined('_GNUBOARD_')) { 
	...
	// 리카운트
	if(isset($_REQUEST['re']) && (int)$_REQUEST['re']) {
		$member['as_noti'] = na_noti_update($member['mb_id']);
	}
...
?>
	<ul class="list-group list-group-flush">
		...
		<?php } ?>
		<li class="list-group-item">
			<a href="javascript:noti_count(1);" class="small">
...
<script>
function noti_count(re) {

	let url = '<?php echo LAYOUT_URL ?>/component/noti.offcanvas.php?cnt=1';
