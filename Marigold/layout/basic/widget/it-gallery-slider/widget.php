...
$md = (isset($wset['md']) && (int)$wset['md'] > 0) ? $wset['md'] : 3;
$lg = (isset($wset['lg']) && (int)$wset['lg'] > 0) ? $wset['lg'] : 3;
$xl = (isset($wset['xl']) && (int)$wset['xl'] > 0) ? $wset['xl'] : 4;
$xxl = (isset($wset['xxl']) && (int)$wset['xxl'] > 0) ? $wset['xxl'] : 4;
...
<?php if($list_cnt) { ?>
	...
	<div id="<?php echo $id ?>" class="it-gallery-slider clearfix">
...
$(function(){
	$('#<?php echo $id ?> .owl-carousel').owlCarousel({
		...
		responsive:{
			0:{ items: <?php echo $xs ?> }, 
			576:{ items: <?php echo $sm ?> }, 
			768:{ items: <?php echo $md ?> }, 
			992:{ items: <?php echo $lg ?> }, 
			1200:{ items: <?php echo $xl ?> },
			1400:{ items: <?php echo $xxl ?> }
		},
		nav:true
	});
});
