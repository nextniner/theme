				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" min="1" name="wset[height]" value="<?php echo $wset['height'] ?>" class="form-control">
				...
				<div class="row align-items-center gx-2 mb-2">
					...
					<div class="col-md-6 col-lg-4">
						<div class="input-group">
							...
							<input type="number" min="1" name="wset[min_height]" value="<?php echo $wset['min_height'] ?>" class="form-control">
