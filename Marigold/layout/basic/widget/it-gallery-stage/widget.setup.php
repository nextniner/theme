...
$wset['md'] = (isset($wset['md']) && (int)$wset['md'] > 0) ? (int)$wset['md'] : 2;
$wset['lg'] = (isset($wset['lg']) && (int)$wset['lg'] > 0) ? (int)$wset['lg'] : 3;
$wset['xl'] = (isset($wset['xl']) && (int)$wset['xl'] > 0) ? (int)$wset['xl'] : 3;
$wset['xxl'] = (isset($wset['xxl']) && (int)$wset['xxl'] > 0) ? (int)$wset['xxl'] : 3;
				...
				<div class="row gx-2">
					...
					<div class="col-md-6 col-lg-4">
						...
						<div class="input-group mb-2">
							...
							<input type="number" min="1" name="wset[lg]" value="<?php echo $wset['lg'] ?>" class="form-control">
							<span class="input-group-text">개</span>
						</div>
