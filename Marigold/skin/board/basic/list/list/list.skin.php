...
// 중단점
$bp = (isset($boset['list_bp']) && $boset['list_bp']) ? $boset['list_bp'] : 'md';

// PC에서 이미지 미리보기
$img_pv = (!G5_IS_MOBILE && (!isset($boset['list_pv']) || !$boset['list_pv'])) ? true : false;

// 목록수
$list_cnt = count($list);
?>

<section id="bo_list" class="list-<?php echo $bp ?> line-top mb-3">
	<ul class="list-group list-group-flush border-bottom">
		<li class="list-group-item d-none d-<?php echo $bp ?>-block hd-wrap">
			<div class="d-flex flex-<?php echo $bp ?>-row align-items-<?php echo $bp ?>-center gap-1 fw-bold">
	...
	<?php 
		for ($i=0; $i < $list_cnt; $i++) { 
			...
			// 이미지 미리보기
			$img_popover = ($img_pv && $img) ? ' data-bs-toggle="popover-img" data-img="'.na_thumb($img, 400, 225).'"' : '';
		?>
			<li class="list-group-item<?php echo $li_css ?>">

				<div class="d-flex align-items-center gap-1">
					<div class="col-1 wr-no d-none d-<?php echo $bp ?>-block">
						<?php echo $row['num'] ?>
					</div>
					<?php if ($is_checkbox) { ?>
						<div>
					...
					<div class="flex-grow-1">
						<div class="d-flex flex-column flex-<?php echo $bp ?>-row align-items-<?php echo $bp ?>-center gap-2">
							<div>
							...
							<div class="ms-<?php echo $bp ?>-auto">
								<div class="d-flex gap-2">
									...
									<div class="wr-date ms-auto text-nowrap order-last order-<?php echo $bp ?>-2">
									...
									<?php if($is_good) { ?>
										<div class="wr-num text-nowrap order-3">
											<i class="bi bi-hand-thumbs-up d-inline-block d-<?php echo $bp ?>-none"></i>
											<?php echo $row['wr_good'] ?>
											<span class="visually-hidden">추천</span>
										</div>
									<?php } ?>
									<div class="wr-num text-nowrap order-4">
										<i class="bi bi-eye d-inline-block d-<?php echo $bp ?>-none"></i>
										<?php echo $row['wr_hit'] ?>
